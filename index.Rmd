...
wp_data_mlm %>% datatable(extensions = 'Buttons', 
                      options = list(
                        dom = 'Bfrtip',   
...
wp_data_mlm %>%
  ...
  summarise(across(where(is.numeric), list(min = min, max = max, mean = mean, SD = sd, count = sum))) %>% mutate_at(c("session_mean", "session_SD", "outcome_mean", "outcome_SD", 
...
#### **Complexity of outcome measures as a moderator**
