...
[This website](https://mshin77.github.io/multilevel-SCD) contains coded data and R code used for four-level multilevel modeling in Shin et al. (in press). Reproducible materials are also posted to the [Center for Open Science](https://doi.org/10.17605/OSF.IO/8WBTA).
