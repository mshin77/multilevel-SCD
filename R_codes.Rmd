...
This webpage contains raw datasets, outputs, and R codes used for the four-level multilevel modeling. Data analysis scripts were also posted through an online data repository at <https://osf.io/8wbta/?view_only=31ca7d3193104652b39dbb4a516a5f00>.
...
var_comp.td$coef <- factor(var_comp.td$coef,levels = c("residual M", "residual B2", "residual A2", "residual B1", "residual A1", "Slope B1", "Level change B1", "Slope A1", "Intercept"))
...
var_m4_plot <- ggplot(var_comp.td, aes(x=pseudo_R_sq_M4, y=coef, fill=level)) +
  ...
  theme(panel.grid.major = element_blank(),
        ...
        legend.position = "bottom") + scale_fill_brewer(palette = "Set2") # scale_fill_grey(start = 0.45, end = 0.9) 
var_m4_plot
```
