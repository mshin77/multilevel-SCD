...
var_comp.td$coef <- factor(var_comp.td$coef,levels = c("M residual", "B2 residual", "A2 residual", "B1 residual", "A1 residual", "B1 trend", "Change in B1 mean", "A1 trend", "Intercept"))
...
var_m4_plot <- ggplot(var_comp.td, aes(x=pseudo_R_sq_M4, y=coef, fill=level)) +
  ...
  # scale_fill_grey(start = 0.45, end = 0.9)
var_m4_plot
```
