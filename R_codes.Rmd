...
var_comp.td$coef <- factor(var_comp.td$coef,levels = c("residual M", "residual B2", "residual A2", "residual B1", "residual A1", "Trend B1", "Level change B1", "Trend A1", "Intercept"))
