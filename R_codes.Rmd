---
title: "Acquisition and Maintenance of Word Problem Solving Moderated by Word Problem Measure Types: Meta-Analysis Using Multilevel Modeling"
date: "`r Sys.Date()`"
output: 
  html_document:
    toc: true
...
wp_data_mlm %>%
  ...
  mutate_at(c("session_SD", "outcome_mean", "outcome_SD", 
              "A_mean", "A_SD", "B_mean", "B_SD", "M_mean", "M_SD"), round, 2) %>%
  mutate_at(c("session_min", "session_max", "session_mean"), round, 0) %>%
  select(authorYear, cluster, case, 
         session_min, session_max, session_mean, session_SD, 
         outcome_min, outcome_max, outcome_mean, outcome_SD,
         A_min, A_max, A_mean, A_SD,  
