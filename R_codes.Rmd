...
plot(ACF(Model.1, maxLag=15), alpha = .01)
```
...
#### **Contextual model with cross-level interactions and heterogenous AR(1) correlation structure (corCAR1)** 

```{r, eval=FALSE}
Model.5 <- update(Model.4, weights = varIdent(form = ~ 1 | design_type))
```
